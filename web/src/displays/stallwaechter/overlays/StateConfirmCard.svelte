<script lang="ts">
  ...
  import {
    fetchStallwaechterHighScores as fetchHighScores,
    type StallwaechterHighScores as HighScores,
  } from '@src/displays/stallwaechter/game-log'
  import type { StateId } from '@src/displays/stallwaechter/game/data/states'
  import { mountTutorialStage } from '@src/displays/stallwaechter/game/tutorial/mountTutorialStage'
  import type { EngineHost } from '@src/stargazer'
  import waveUrl from '@src/displays/stallwaechter/assets/confirm-wave-card.svg?url'
