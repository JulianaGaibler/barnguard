...
<div class="tc">
  <div class="tc__media" aria-hidden="true"></div>
  <div class="tc__text">
    <h3 class="tc__title">{title}</h3>
    <p class="tc__body">{body}</p>
  </div>
</div>
