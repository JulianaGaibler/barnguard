/**
 * Win celebration: a disc bursts into shrapnel (triangles + line shards) that
 * fly outward under exponential drag while spinning, shrinking as they slow so
 * the burst dissolves to nothing and the node self-destructs. Adapted from
 * Orbo's OrbExplodeNode. Spawned on each cell of the winning line.
 *
...
export class WinBurstNode extends SceneNode {
