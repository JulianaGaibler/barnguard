<!--
  Pause menu, the one modal during play. Built from the shared `Surface` +
  `Button`, with all color from the theme. Resume returns to the board, Quit
  ends the run and returns to the 2048 menu.
-->
<script lang="ts">
  ...
  <div class="pause__card" transition:scale={{ start: 0.92, duration: 180 }}>
    <Surface tone="light">
      <div class="pause__body">
        <h2 class="pause__title">{t.pauseTitle}</h2>
