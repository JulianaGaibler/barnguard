/**
 * The one drawing primitive this game is built out of: a chunky slab, lit and
 * turned on a single axis.
 *
 ...
 * so a column of tiles shares one silhouette left and right.
 *
 ...
 * what lets a tile sit inside its grid cell instead of overflowing it.
 *
 * Every edge is hard. There are no blurred shadows anywhere in 2048.
 *
 * @example
 *   drawSlab(gfx, {
 *     x,
