...
import bwUrl from '../../assets/state-images/BW.jpg?url'
import byUrl from '../../assets/state-images/BY.jpg?url'
import beUrl from '../../assets/state-images/BE.jpg?url'
import bbUrl from '../../assets/state-images/BB.jpg?url'
import hbUrl from '../../assets/state-images/HB.jpg?url'
import hhUrl from '../../assets/state-images/HH.jpg?url'
import heUrl from '../../assets/state-images/HE.jpg?url'
import mvUrl from '../../assets/state-images/MV.jpg?url'
import niUrl from '../../assets/state-images/NI.jpg?url'
import nwUrl from '../../assets/state-images/NW.jpg?url'
import rpUrl from '../../assets/state-images/RP.jpg?url'
import slUrl from '../../assets/state-images/SL.jpg?url'
import snUrl from '../../assets/state-images/SN.jpg?url'
import stUrl from '../../assets/state-images/ST.jpg?url'
import shUrl from '../../assets/state-images/SH.jpg?url'
import thUrl from '../../assets/state-images/TH.jpg?url'
