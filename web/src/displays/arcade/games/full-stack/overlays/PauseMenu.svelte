...
<div class="fs-pause" transition:fade={{ duration: 150 }}>
  <div class="fs-pause__card" transition:scale={{ start: 0.92, duration: 200 }}>
    <Surface tone="light">
      <div class="fs-pause__body">
        <h2 class="fs-pause__title">{t.paused}</h2>
        <div class="fs-pause__actions">
