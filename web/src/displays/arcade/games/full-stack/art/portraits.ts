...
// here draws a whole person. A portrait is composed from four small libraries: a
// garment, a hair style, a set of extras, over one fixed head.
//
...
// Garments paint before the head so they overlap it and read with more depth.
const GARMENTS = {
  tee: {
    11: '....cc....cc....',
    12: '...cccc..cccc...',
...
/** Resolve one card's glyph alphabet, computing shadows automatically. */
const paletteFor = (
  ...
  return {
    palette: {
      s: skin,
      S: skinShadow, // Doubles as blush or nose shading
