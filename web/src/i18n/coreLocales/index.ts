 ...
 * their own bundles by spreading one of these entries and then adding their own
 * message sections. Kept as a plain lookup so a display can also cherry- pick a
 * language it wants to reuse verbatim.
 */
