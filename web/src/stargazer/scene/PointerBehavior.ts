...
import type { PointerHandlers } from './SceneNode'
 ...
 * base wires them via {@link SceneNode.bindPointer} on attach and unbinds on
 * detach (including a synthetic cancel if a capture is live), so the
 * bind/unbind bookkeeping stops being copied into every input behavior.
 *
 * @category Scene
 * @example
