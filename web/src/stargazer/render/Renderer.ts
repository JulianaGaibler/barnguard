 ...
 * (backed by a `WebGL2Device`) takes ownership of the WebGL2 context. Renderer
 * itself is backend-agnostic, every drawing operation and every context
 * acquisition goes through the facade layer above.
 *
