...
export class MockGfxDevice implements GfxDevice {
  ...
  private curProgram: Program | null = null
  private curBlend: GfxBlendMode = 'source-over'
  private curTexture: Texture | null = null
  private lastBufferBytes: ArrayBuffer | null = null
  ...
  updateBufferSubData(
    ...
    this.lastBufferBytes = (src.buffer as ArrayBuffer).slice(start, start + len)
    void bpe
  }
